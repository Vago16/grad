...
#freeze all layers for optimal performance on CPU
for param in model.parameters():
    param.requires_grad = True  # set to False if you want only to train last layer
...
for epoch in range(num_epochs):
    ...
    if val_acc > best_val_acc:
        ...
        best_model_wts = copy.deepcopy(model.state_dict())
        torch.save(best_model_wts, "best_resnet50_ultrafast.pth")
...
print("Best model weights saved as 'best_resnet50_ultrafast.pth'")
